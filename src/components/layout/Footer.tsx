          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8 mb-8 sm:mb-12">
            ...
            <div className="sm:col-span-2 lg:col-span-1 space-y-4 sm:space-y-6">
              <div className="flex items-center gap-3">
                <div className="w-10 h-10 sm:w-12 sm:h-12 bg-gradient-to-br from-accent to-secondary rounded-xl flex items-center justify-center">
                  <GraduationCap className="w-5 h-5 sm:w-6 sm:h-6 lg:w-7 lg:h-7 text-primary-foreground" />
                </div>
                <div>
                  <h3 className="text-xl sm:text-2xl font-bold bg-gradient-to-r from-accent to-secondary bg-clip-text text-transparent">
                    Dream Coaching
                  </h3>
                  <p className="text-xs sm:text-sm text-primary-foreground/70">Excellence in Education</p>
                </div>
              </div>
              ...
              <div className="grid grid-cols-2 gap-3 sm:gap-4">
                <div className="text-center p-2 sm:p-3 bg-primary-foreground/10 rounded-lg">
                  <div className="text-lg sm:text-2xl font-bold text-accent">10K+</div>
                  <div className="text-xs text-primary-foreground/70">Students</div>
                </div>
                <div className="text-center p-2 sm:p-3 bg-primary-foreground/10 rounded-lg">
                  <div className="text-lg sm:text-2xl font-bold text-secondary">50+</div>
              ...
              <div className="flex gap-2 sm:gap-3 justify-center sm:justify-start">
                {[
                  ...
                  <a
                    key={social.name}
                    href={social.href}
                    className={`w-8 h-8 sm:w-10 sm:h-10 bg-primary-foreground/10 ${social.bgColor} rounded-lg flex items-center justify-center transition-all duration-200 hover:scale-110`}
            ...
            <div className="space-y-4 sm:space-y-6">
              <h4 className="text-base sm:text-lg font-semibold text-accent">Quick Links</h4>
              <ul className="space-y-2 sm:space-y-3">
                {[
                  ...
                  <li key={link.href}>
                    <Link 
                      href={link.href}
                      className="flex items-center gap-2 text-primary-foreground/80 hover:text-accent transition-colors duration-200 group text-sm sm:text-base"
                    >
            ...
            {/* Courses */}
            <div className="space-y-4 sm:space-y-6">
              <h4 className="text-base sm:text-lg font-semibold text-accent">Popular Courses</h4>
              <ul className="space-y-2 sm:space-y-3">
                {[
                  ...
                  <li key={course}>
                    <a 
                      href="#"
                      className="flex items-center gap-2 text-primary-foreground/80 hover:text-secondary transition-colors duration-200 group text-sm sm:text-base"
                    >
            ...
            <div className="space-y-4 sm:space-y-6">
              ...
              <div className="space-y-3 sm:space-y-4">
                ...
                <div className="flex items-center gap-2 sm:gap-3">
                  <div className="w-7 h-7 sm:w-8 sm:h-8 bg-primary-foreground/20 rounded-lg flex items-center justify-center">
                    <MapPin className="w-3 h-3 sm:w-4 sm:h-4 text-primary-foreground" />
                  </div>
                  <div>
              ...
              {/* Newsletter */}
              <div className="bg-primary-foreground/10 rounded-xl p-3 sm:p-4">
                <h5 className="text-xs sm:text-sm font-semibold mb-2">Newsletter</h5>
                ...
                <div className="flex gap-2">
                  <Input 
                    ...
                    className="text-xs bg-primary-foreground/5 border-primary-foreground/20 text-primary-foreground placeholder:text-primary-foreground/50 h-8 sm:h-9"
                  />
                  <Button size="sm" className="bg-accent hover:bg-accent/90 text-accent-foreground h-8 sm:h-9 px-2 sm:px-3">
